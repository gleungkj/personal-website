...
beforeEach(() => {
    ...
    jest.spyOn(Framer, 'useInView').mockReturnValue(false)
})
...
describe('ExperienceContractedPanel', () => {
    it('should render ExperienceContractedPanel', () => {
        render(
            <ExperienceContractedPanel {...mockExperienceContractPanelProps} />
        )
    ...
    it('should call setPanelExpanded if clicked', async () => {
        ...
        expect(
            mockExperienceContractPanelProps.setPanelExpanded
