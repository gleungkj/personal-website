...
import * as contractedPanel from '@/components/Panel/ExperienceContractedPanel/ExperienceContractedPanel'
...
jest.mock(
    '../Panel/ExperienceContractedPanel/ExperienceContractedPanel',
    () => {
        return {
            __esModule: true,
            ...jest.requireActual(
...
jest.mock('../Panel/ExperienceExpandedPanel/ExperienceExpandedPanel', () => {
    return {
        __esModule: true,
        ...jest.requireActual(
            '../Panel/ExperienceExpandedPanel/ExperienceExpandedPanel'
        ),
    }
})
...
beforeEach(() => {
    jest.spyOn(contractedPanel, 'ExperienceContractedPanel').mockReturnValue(
        <div></div>
    )
    jest.spyOn(expandedPanel, 'ExperienceExpandedPanel').mockReturnValue(
        <div></div>
    )
})
...
describe('ExperiencePanel', () => {
    it('should contain ExperienceContractedPanel by default', async () => {
        ...
        await render(
            <ExperiencePanel experienceData={mockExperiencePanelData} />
        )
